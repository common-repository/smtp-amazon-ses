		  ...
		  <div class="setting-field">
			...
			<div>
			  ...
			  <div class="yay-tooltip icon-tootip-wrap">
				...
				<span class="yay-tooltiptext yay-tooltip-bottom"><?php echo esc_html__( 'Always send emails with the above From Email address, overriding other plugins settings.', 'smtp-amazon-ses' ); ?></span>
			  </div>
			</div>
		...
		<div class="setting-from-name">
		  ...
		  <div class="setting-field">
			...
			<div>
			  ...
			  <div class="yay-tooltip icon-tootip-wrap">
				<span class="icon-inst-tootip"></span>
				<span class="yay-tooltiptext yay-tooltip-bottom"><?php echo esc_html__( 'Always send emails with the above From Name, overriding other plugins settings.', 'smtp-amazon-ses' ); ?></span>
			  </div>
			</div>
		  </div>
		</div>
